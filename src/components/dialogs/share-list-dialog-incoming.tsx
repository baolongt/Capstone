...
import { useListSharedIncoming } from '@/apis/incomingDocument/list-shared';
import { useUpdateListShared } from '@/apis/incomingDocument/update-list-shared';
import { useUpdateListUnShared } from '@/apis/incomingDocument/update-list-unshared';
...
export const ShareListIncomingDialog: React.FC<ShareListDialogProps> = ({
  isOpen,
  onClose
}) => {
  ...
  } = useListSharedIncoming(Number(id));
